...
<div class="section section-padding services-line">
    <div class="container"> 
        ...
        <div class="row"> 
            <?php foreach ($settings['services_list'] as $services) { 
                ...
                ?>  
                    <div class="<?php echo esc_attr($col_class); ?> elementor-repeater-item-<?php echo esc_attr( $services['_id'] );?>" data-sal="slide-up" data-sal-duration="800" data-sal-delay="100"> 
                        <div class="services-grid service-style-3  <?php  echo esc_attr( $active );?>">
            ...
            <?php   
                ...
                if ( $settings['furl']['url'] ) {
                    $btn = ' <div class="btn-wrp-new has-icon text-center"><a class="btn-large axil-btn  ' . $settings['btn_type'] . '" ' . $attr . '>'.$settings['furltext'] .'</div></a>';
                } ?>
                 <?php echo wp_kses( $btn, $allowed_tags ); ?>
