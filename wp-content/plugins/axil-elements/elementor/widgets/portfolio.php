...
class axil_Projects extends Widget_Base {

 use \Elementor\AxilElementCommonFunctions;

 public function get_name() {
        return 'axil-Project-isotope';
    }    
    public function get_title() {
        return esc_html__( 'Projects', 'axil-elements' );
    }
    ...
    $this->axil_section_title('projects', 'Section Title', 'h2', true, 'left');
      ...
      $this->axil_query_controls('query', 'Project', 'axil-projects', 'axil-projects-category');
        ...
        $this->add_control(
         ...
         $this->add_control(
            'project_link_img_disable',
            [
                'label'        => esc_html__('All Project Image Link Disable', 'axil-elements'),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__('Yes', 'axil-elements'),
                'label_off'    => esc_html__('No', 'axil-elements'),
                'return_value' => 'yes',
         ...
         $this->add_control(
            'project_content_disable',
            [
                'label'        => esc_html__('All Project Content Disable', 'axil-elements'),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__('Yes', 'axil-elements'),
                'label_off'    => esc_html__('No', 'axil-elements'),
                'return_value' => 'yes',
         ...
         $this->add_control(
            'project_img_popup_disable',
            [
                'label'        => esc_html__('Imge Popups Disable', 'axil-elements'),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__('Yes', 'axil-elements'),
                'label_off'    => esc_html__('No', 'axil-elements'),
                'return_value' => 'yes',
                ...
                'condition' => [
                    'project_link_img_disable!' => 'yes'
                ]
            ]
        );

        $this->add_control(
            'project_title_link_disable',
            [
                'label'        => esc_html__('All Project Title Link Disable', 'axil-elements'),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__('Yes', 'axil-elements'),
                'label_off'    => esc_html__('No', 'axil-elements'),
                'return_value' => 'yes',
	...
	protected function render() {
        ...
        $col_class = "col-xl-{$settings['col_xl']} col-lg-{$settings['col_lg']} col-md-{$settings['col_md']} col-sm-{$settings['col_sm']} project";
         ...
         $allowed_tags = wp_kses_allowed_html( 'post' );
          ...
          $project_content_disable = ( $settings['project_content_disable'] == 'yes') ? " project_content_disable_no" : " project_content_disable_yes";
        ?>
                            ...
                            <div class="<?php echo esc_attr($col_class); ?>  <?php echo esc_attr($active); ?> <?php echo esc_attr($termsAssignedCat); ?>">
                                 <div class="project-grid">
                                    <div class="thumbnail <?php echo esc_attr($project_content_disable); ?>">
                                        ...
                                        <?php if ( $settings['project_link_img_disable'] == 'yes' ) { ?> 
                                            <a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('axil-project-thumb'); ?></a>
                                        <?php  }else{  ?>    
                                                <?php if ( $settings['project_img_popup_disable'] == 'yes' ) { ?>  
                                    ...
                                    <?php if ( $settings['project_content_disable'] == 'yes' ) { ?>  
                                     
                                        <div class="content">
                                            <?php if ( $settings['project_title_link_disable'] == 'yes' ) { ?> 
