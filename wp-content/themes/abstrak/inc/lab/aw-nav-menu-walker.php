...
if (!class_exists('AxilNavWalker')) {
    class AxilNavWalker extends Walker_Nav_Menu
    {
        ...
        public function start_lvl(&$output, $depth = 0, $args = array())
        {
            ...
            // Default class.
            $classes = array('axil-submenu department-megamenu');
        ...
        public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
        {
            ...
            $mega_menu_template = '';
            if( class_exists('acf') ) {
                $enable_mega_menu = get_field('abstrak_enable_mega_menu', $item);
                $mega_menu_template = get_field('abstrak_select_mega_menu', $item);
            }
            global $post;
            ...
            $post_type_class = 'axil-post-type-' . get_post_type( get_the_ID() );
            ...
            $title = apply_filters( 'axiltheme_navmenu_icon_item_title', $title, $item, $args, $depth, $this->icon_display , $this->text_display ); 
